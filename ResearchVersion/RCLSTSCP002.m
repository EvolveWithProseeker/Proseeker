function [letsgo]= RCLSTSCP002(letsgo) 
...
for switchindex=1:25
    switch switchindex
        case 1
            subject=coder.load('p26.csvx');
        case 2
            subject=coder.load('p27.csvx');
        case 3
            subject=coder.load('p28.csvx');
        case 4
            subject=coder.load('p29.csvx');
        case 5
            subject=coder.load('p30.csvx');
        case 6
            subject=coder.load('p31.csvx');
        case 7
            subject=coder.load('p32.csvx');
        case 8
            subject=coder.load('p33.csvx');
        case 9
            subject=coder.load('p34.csvx');
        case 10
            subject=coder.load('p35.csvx');
        case 11
            subject=coder.load('p36.csvx');
        case 12
            subject=coder.load('p37.csvx');
        case 13
            subject=coder.load('p38.csvx');
        case 14
            subject=coder.load('p39.csvx');
        case 15
            subject=coder.load('p40.csvx');
        case 16
            subject=coder.load('p41.csvx');
        case 17
            subject=coder.load('p42.csvx');
        case 18
            subject=coder.load('p43.csvx');
        case 19
            subject=coder.load('p44.csvx');
        case 20
            subject=coder.load('p45.csvx');
        case 21
            subject=coder.load('p46.csvx');
        case 22
            subject=coder.load('p47.csvx');
        case 23
            subject=coder.load('p48.csvx');
        case 24
            subject=coder.load('p49.csvx');
        case 25
            subject=coder.load('p50.csvx');
    end
    ...
    switch switchindex
        case 1
            dlmwrite('p26.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 2
            dlmwrite('p27.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 3
            dlmwrite('p28.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 4
            dlmwrite('p29.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 5
            dlmwrite('p30.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 6
            dlmwrite('p31.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 7
            dlmwrite('p32.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 8
            dlmwrite('p33.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 9
            dlmwrite('p34.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 10
            dlmwrite('p35.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 11
            dlmwrite('p36.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 12
            dlmwrite('p37.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 13
            dlmwrite('p38.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 14
            dlmwrite('p39.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 15
            dlmwrite('p40.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 16
            dlmwrite('p41.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 17
            dlmwrite('p42.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 18
            dlmwrite('p43.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 19
            dlmwrite('p44.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 20
            dlmwrite('p45.csvx.gofcheck.csv', goodnessmatfin);
           goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 21
            dlmwrite('p46.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 22
            dlmwrite('p47.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 23
            dlmwrite('p48.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 24
            dlmwrite('p49.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 25
            dlmwrite('p50.csvx.gofcheck.csv', goodnessmatfin);
