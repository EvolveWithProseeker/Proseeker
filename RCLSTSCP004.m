function [letsgo]= RCLSTSCP004(letsgo) 
...
for switchindex=1:25
    switch switchindex
        case 1
            subject=coder.load('p76.csvx');
        case 2
            subject=coder.load('p77.csvx');
        case 3
            subject=coder.load('p78.csvx');
        case 4
            subject=coder.load('p79.csvx');
        case 5
            subject=coder.load('p80.csvx');
        case 6
            subject=coder.load('p81.csvx');
        case 7
            subject=coder.load('p82.csvx');
        case 8
            subject=coder.load('p83.csvx');
        case 9
            subject=coder.load('p84.csvx');
        case 10
            subject=coder.load('p85.csvx');
        case 11
            subject=coder.load('p86.csvx');
        case 12
            subject=coder.load('p87.csvx');
        case 13
            subject=coder.load('p88.csvx');
        case 14
            subject=coder.load('p89.csvx');
        case 15
            subject=coder.load('p90.csvx');
        case 16
            subject=coder.load('p91.csvx');
        case 17
            subject=coder.load('p92.csvx');
        case 18
            subject=coder.load('p93.csvx');
        case 19
            subject=coder.load('p94.csvx');
        case 20
            subject=coder.load('p95.csvx');
        case 21
            subject=coder.load('p96.csvx');
        case 22
            subject=coder.load('p97.csvx');
        case 23
            subject=coder.load('p98.csvx');
        case 24
            subject=coder.load('p99.csvx');
        case 25
            subject=coder.load('p100.csvx');
    end
    ...
    switch switchindex
        case 1
            dlmwrite('p76.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 2
            dlmwrite('p77.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 3
            dlmwrite('p78.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 4
            dlmwrite('p79.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 5
            dlmwrite('p80.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 6
            dlmwrite('p81.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 7
            dlmwrite('p82.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 8
            dlmwrite('p83.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 9
            dlmwrite('p84.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 10
            dlmwrite('p85.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 11
            dlmwrite('p86.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 12
            dlmwrite('p87.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 13
            dlmwrite('p88.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 14
            dlmwrite('p89.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 15
            dlmwrite('p90.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 16
            dlmwrite('p91.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 17
            dlmwrite('p92.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 18
            dlmwrite('p93.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 19
            dlmwrite('p94.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 20
            dlmwrite('p95.csvx.gofcheck.csv', goodnessmatfin);
           goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 21
            dlmwrite('p96.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 22
            dlmwrite('p97.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 23
            dlmwrite('p98.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 24
            dlmwrite('p99.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 25
            dlmwrite('p100.csvx.gofcheck.csv', goodnessmatfin);
