function [letsgo]= RCLSTSCP001(letsgo) 
...
for switchindex=1:25
    switch switchindex
        case 1
            subject=coder.load('p1.csvx');
        case 2
            subject=coder.load('p2.csvx');
        case 3
            subject=coder.load('p3.csvx');
        case 4
            subject=coder.load('p4.csvx');
        case 5
            subject=coder.load('p5.csvx');
        case 6
            subject=coder.load('p6.csvx');
        case 7
            subject=coder.load('p7.csvx');
        case 8
            subject=coder.load('p8.csvx');
        case 9
            subject=coder.load('p9.csvx');
        case 10
            subject=coder.load('p10.csvx');
        case 11
            subject=coder.load('p11.csvx');
        case 12
            subject=coder.load('p12.csvx');
        case 13
            subject=coder.load('p13.csvx');
        case 14
            subject=coder.load('p14.csvx');
        case 15
            subject=coder.load('p15.csvx');
        case 16
            subject=coder.load('p16.csvx');
        case 17
            subject=coder.load('p17.csvx');
        case 18
            subject=coder.load('p18.csvx');
        case 19
            subject=coder.load('p19.csvx');
        case 20
            subject=coder.load('p20.csvx');
        case 21
            subject=coder.load('p21.csvx');
        case 22
            subject=coder.load('p22.csvx');
        case 23
            subject=coder.load('p23.csvx');
        case 24
            subject=coder.load('p24.csvx');
        case 25
            subject=coder.load('p25.csvx');
    end
    ...
    switch switchindex
        case 1
            dlmwrite('p1.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 2
            dlmwrite('p2.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 3
            dlmwrite('p3.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 4
            dlmwrite('p4.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 5
            dlmwrite('p5.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 6
            dlmwrite('p6.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 7
            dlmwrite('p7.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 8
            dlmwrite('p8.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 9
            dlmwrite('p9.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 10
            dlmwrite('p10.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 11
            dlmwrite('p11.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 12
            dlmwrite('p12.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 13
            dlmwrite('p13.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 14
            dlmwrite('p14.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 15
            dlmwrite('p15.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 16
            dlmwrite('p16.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 17
            dlmwrite('p17.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 18
            dlmwrite('p18.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 19
            dlmwrite('p19.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 20
            dlmwrite('p20.csvx.gofcheck.csv', goodnessmatfin);
           goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 21
            dlmwrite('p21.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 22
            dlmwrite('p22.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 23
            dlmwrite('p23.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 24
            dlmwrite('p24.csvx.gofcheck.csv', goodnessmatfin);
            goodnessmatfin(:,:)=0;
            subtractmat(:,:)=0;
        case 25
            dlmwrite('p25.csvx.gofcheck.csv', goodnessmatfin);
